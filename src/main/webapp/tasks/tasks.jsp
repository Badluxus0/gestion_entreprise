...
<head>
    ...
    <meta name="description" content="Système de gestion des taches">
...
<div class="container mb-5">
    ...
    <div class="d-flex justify-content-between align-items-center mt-3 mb-3">
        ...
        <a class="btn btn-primary" href="${pageContext.request.contextPath}/tasks/taskForm.jsp">
            <i class="fas fa-plus me-2"></i>Ajouter une tache
        </a>
    </div>
            ...
            <c:forEach var="task" items="${tasks}">
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group" role="group" aria-label="Actions pour cet employé">
                            <a class="btn btn-sm btn-warning" href="?action=edit&id=${task.id}"><i
                                    class="fas fa-edit"></i></a><span class="visually-hidden">Modifier</span>
                            ...
                            <button class="btn btn-sm btn-success assign-btn" data-bs-toggle="modal"
                                    ...
                                    data-task-id="${task.id}" title="Assigner un employé">
...
<div class="modal fade" id="confirmDeleteModal" tabindex="-1" aria-labelledby="confirmDeleteModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Êtes-vous sûr de vouloir supprimer la tache avec l'ID <strong id="IDtask"></strong> ?
            </div>
            <div class="modal-footer">
    ...
    document.addEventListener("DOMContentLoaded", function () {
        ...
        assignButtons.forEach(button => {
            button.addEventListener("click", function () {
                document.getElementById("taskId").value = button.getAttribute("data-task-id");
            });
        });
    });
</script>
<script>
    function showDeleteModal(taskId) {
        document.getElementById("IDtask").textContent = taskId;
